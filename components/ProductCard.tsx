  ...
  return (
    <div className="group border-4 border-[var(--text-primary)] bg-[var(--bg-primary)] hover:-translate-y-2 transition-transform duration-300 flex flex-col rounded-none">
      ...
      <div className="p-6 border-t-4 border-[var(--text-primary)] flex flex-col flex-1">
        ...
        <p className="text-xl font-medium text-[var(--text-primary)]/70 mb-8">
          {product.price}
        </p>
        
        <button className="mt-auto w-full bg-[var(--cta-bg)] text-[var(--cta-text)] text-sm font-bold uppercase tracking-widest py-3 hover:opacity-90 transition-colors rounded-none">
